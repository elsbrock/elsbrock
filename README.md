...
- [FutureProofHomes/Satellite1-ESPHome](https://github.com/FutureProofHomes/Satellite1-ESPHome) - Open Source ESPHome Firmware for Your Private AI-Powered Satellite1 Voice Assistant &amp; Multisensor (today)
...
- [universal-tool-calling-protocol/utcp-mcp](https://github.com/universal-tool-calling-protocol/utcp-mcp) - All-in-one MCP server that can connect your AI agents to any native endpoint, powered by UTCP (6 days ago)
