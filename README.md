...
- [twpayne/chezmoi](https://github.com/twpayne/chezmoi) ([v2.15.3](https://github.com/twpayne/chezmoi/releases/tag/v2.15.3), 1 day ago) - Manage your dotfiles across multiple diverse machines, securely.
- [coder/code-server](https://github.com/coder/code-server) ([v4.4.0](https://github.com/coder/code-server/releases/tag/v4.4.0), 3 days ago) - VS Code in the browser
...
- [lyrebird-voice-changer/lyrebird](https://github.com/lyrebird-voice-changer/lyrebird) - 🦜 Simple and powerful voice changer for Linux, written in GTK 3. (3 days ago)
- [c-grimshaw/gosniff](https://github.com/c-grimshaw/gosniff) - A fancy-schmancy tcpdump-esque TUI, programmed in Go. (1 week ago)
