...
- [0xERR0R/blocky](https://github.com/0xERR0R/blocky) ([v0.33.0](https://github.com/0xERR0R/blocky/releases/tag/v0.33.0), 4 days ago) - Fast and lightweight DNS proxy as ad-blocker for local network with many features
...
- [AminForou/mcp-gsc](https://github.com/AminForou/mcp-gsc) - Google Search Console Insights with Claude AI for SEOs (today)
