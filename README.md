...
- [paoloricciuti/tmcp](https://github.com/paoloricciuti/tmcp) - Typescript SDK to build MCP servers in an agnostic way (1 day ago)
...
- [r59q/geekbench-cpu-specs](https://github.com/r59q/geekbench-cpu-specs) - CPU specs from geekbench in a json file (3 days ago)
- [dantraynor/tailchrome](https://github.com/dantraynor/tailchrome) - Tailscale Chrome extension (3 days ago)
