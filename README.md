...
- [hacs/default](https://github.com/hacs/default) - The home of the default HACS repositories. (3 days ago)
...
- [2Retr0/GodotOceanWaves](https://github.com/2Retr0/GodotOceanWaves) - FFT-based ocean-wave rendering, implemented in Godot (2 days ago)
- [paulrobello/parllama](https://github.com/paulrobello/parllama) - TUI for Ollama (4 days ago)
- [deggja/netfetch](https://github.com/deggja/netfetch) - Kubernetes tool for scanning clusters for network policies and identifying unprotected workloads. (4 days ago)
