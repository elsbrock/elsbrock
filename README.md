...
- [elsbrock/edgerouter-backup](https://github.com/elsbrock/edgerouter-backup) - :outbox_tray: Backing up the configuration of Ubiquiti&#39;s Edgerouter to a Github repository (4 days ago)
...
- [elsbrock/go-ghwrite](https://github.com/elsbrock/go-ghwrite) ([v0.3.0](https://github.com/elsbrock/go-ghwrite/releases/tag/v0.3.0), 3 days ago) - :octocat: Commit file(s) to a Github repo using the GitHub v3 API
...
- [docs: personal access token not needed with `--ssh`](https://github.com/twpayne/chezmoi/pull/1818) on [twpayne/chezmoi](https://github.com/twpayne/chezmoi) (5 days ago)
- [fix: get install.sh working on UbuntuWSL](https://github.com/ellie/atuin/pull/260) on [ellie/atuin](https://github.com/ellie/atuin) (6 days ago)
...
- [floooh/pacman.c](https://github.com/floooh/pacman.c) - Simple Pacman clone written in C99. (1 day ago)
- [dimitri/pgcopydb](https://github.com/dimitri/pgcopydb) - Copy a Postgres database to a target Postgres server (pg_dump | pg_restore on steroids) (1 day ago)
- [ecocurious2/MultiGeiger](https://github.com/ecocurious2/MultiGeiger) - Geigerzähler mit ESP32 und empfindlichem Si22g-Zählrohr (Gamma)  (2 days ago)
- [leahneukirchen/te](https://github.com/leahneukirchen/te) - tiny emacs (2 days ago)
