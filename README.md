...
- [miekg/dns](https://github.com/miekg/dns) - DNS library in Go (4 days ago)
...
- [twpayne/chezmoi](https://github.com/twpayne/chezmoi) ([v2.27.1](https://github.com/twpayne/chezmoi/releases/tag/v2.27.1), 3 days ago) - Manage your dotfiles across multiple diverse machines, securely.
- [coder/code-server](https://github.com/coder/code-server) ([v4.9.0-rc.1](https://github.com/coder/code-server/releases/tag/v4.9.0-rc.1), 6 days ago) - VS Code in the browser
...
- [fix: example in docs with invalid syntax](https://github.com/miekg/dns/pull/1401) on [miekg/dns](https://github.com/miekg/dns) (4 days ago)
- [fix: example in docs with invalid syntax](https://github.com/elsbrock/dns/pull/1) on [elsbrock/dns](https://github.com/elsbrock/dns) (4 days ago)
...
- [sijms/go-ora](https://github.com/sijms/go-ora) - Pure go oracle client (today)
...
- [timothycrosley/streamdeck-ui](https://github.com/timothycrosley/streamdeck-ui) - A Linux compatible UI for the Elgato Stream Deck. (4 days ago)
