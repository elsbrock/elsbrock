...
- [twpayne/chezmoi](https://github.com/twpayne/chezmoi) ([v2.20.0](https://github.com/twpayne/chezmoi/releases/tag/v2.20.0), 6 days ago) - Manage your dotfiles across multiple diverse machines, securely.
- [coder/code-server](https://github.com/coder/code-server) ([v4.5.1](https://github.com/coder/code-server/releases/tag/v4.5.1), 2 weeks ago) - VS Code in the browser
...
- [gnif/LookingGlass](https://github.com/gnif/LookingGlass) - An extremely low latency KVMFR (KVM FrameRelay) implementation for guests with VGA PCI Passthrough. (4 days ago)
