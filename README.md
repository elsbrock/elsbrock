...
- [fix(*arr): add UMask to systemd services for proper group permissions](https://github.com/rasmus-kirk/nixarr/pull/133) on [rasmus-kirk/nixarr](https://github.com/rasmus-kirk/nixarr) (3 days ago)
...
- [open-source-labs/Svelvet](https://github.com/open-source-labs/Svelvet) - 🎛 A Svelte library for building dynamic, infinitely customizable node-based user interfaces and flowcharts (today)
