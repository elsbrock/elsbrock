...
- [fix(qbittorrent): deep-merge extraConfig with lib.recursiveUpdate](https://github.com/nix-media-server/nixarr/pull/146) on [nix-media-server/nixarr](https://github.com/nix-media-server/nixarr) (2 days ago)
...
- [apache/flink](https://github.com/apache/flink) - Apache Flink (3 days ago)
- [apache/paimon](https://github.com/apache/paimon) - Apache Paimon is a lake format that enables building a Realtime Lakehouse Architecture with Flink and Spark for both streaming and batch operations. (3 days ago)
- [harperaa/bastionclaw-mission-control](https://github.com/harperaa/bastionclaw-mission-control) -  (5 days ago)
- [harperaa/bastionclaw](https://github.com/harperaa/bastionclaw) - Personal AI assistant with container isolation and semantic memory (5 days ago)
