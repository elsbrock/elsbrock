...
- [elsbrock/plundrio](https://github.com/elsbrock/plundrio) ([v0.11.1](https://github.com/elsbrock/plundrio/releases/tag/v0.11.1), 2 days ago) - 🏴‍☠️ put.io download client for *arr implementing the transmission RPC interface
- [0xERR0R/blocky](https://github.com/0xERR0R/blocky) ([v0.34.0](https://github.com/0xERR0R/blocky/releases/tag/v0.34.0), 5 days ago) - Fast and lightweight DNS proxy as ad-blocker for local network with many features
...
- [GrieferPig/esp32-s31-linux](https://github.com/GrieferPig/esp32-s31-linux) - Porting MMU Linux to ESP32-S31 (today)
