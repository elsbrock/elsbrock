...
- [coder/code-server](https://github.com/coder/code-server) ([v4.7.1](https://github.com/coder/code-server/releases/tag/v4.7.1), 1 day ago) - VS Code in the browser
- [twpayne/chezmoi](https://github.com/twpayne/chezmoi) ([v2.24.0](https://github.com/twpayne/chezmoi/releases/tag/v2.24.0), 6 days ago) - Manage your dotfiles across multiple diverse machines, securely.
...
- [cbreak-black/ZetaWatch](https://github.com/cbreak-black/ZetaWatch) - ZFS OSX Menu Bar widget (2 days ago)
- [stoically/temporary-containers](https://github.com/stoically/temporary-containers) - Firefox Add-on that lets you open automatically managed disposable containers (2 days ago)
- [openai/whisper](https://github.com/openai/whisper) - Robust Speech Recognition via Large-Scale Weak Supervision (4 days ago)
- [kennyp/asdf-golang](https://github.com/kennyp/asdf-golang) - golang plugin for asdf version manager https://github.com/asdf-vm/asdf (4 days ago)
