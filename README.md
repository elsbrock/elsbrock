...
- [coder/code-server](https://github.com/coder/code-server) ([v4.9.1-rc.1](https://github.com/coder/code-server/releases/tag/v4.9.1-rc.1), 2 days ago) - VS Code in the browser
