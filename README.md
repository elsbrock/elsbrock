...
- [twpayne/chezmoi](https://github.com/twpayne/chezmoi) ([v2.15.0](https://github.com/twpayne/chezmoi/releases/tag/v2.15.0), today) - Manage your dotfiles across multiple diverse machines, securely.
...
- [Wilfred/difftastic](https://github.com/Wilfred/difftastic) - a diff that understands syntax 🟥🟩 (5 days ago)
- [oz/tz](https://github.com/oz/tz) - 🌐 A time zone helper (6 days ago)
- [magic-wormhole/magic-wormhole](https://github.com/magic-wormhole/magic-wormhole) - get things from one computer to another, safely (6 days ago)
