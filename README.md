...
- [fix(qbittorrent): deep-merge extraConfig with lib.recursiveUpdate](https://github.com/nix-media-server/nixarr/pull/146) on [nix-media-server/nixarr](https://github.com/nix-media-server/nixarr) (1 day ago)
...
- [apache/flink](https://github.com/apache/flink) - Apache Flink (2 days ago)
- [apache/paimon](https://github.com/apache/paimon) - Apache Paimon is a lake format that enables building a Realtime Lakehouse Architecture with Flink and Spark for both streaming and batch operations. (2 days ago)
- [harperaa/bastionclaw-mission-control](https://github.com/harperaa/bastionclaw-mission-control) -  (4 days ago)
- [harperaa/bastionclaw](https://github.com/harperaa/bastionclaw) - Personal AI assistant with container isolation and semantic memory (4 days ago)
