...
- [prometheus-pve/prometheus-pve-exporter](https://github.com/prometheus-pve/prometheus-pve-exporter) - Exposes information gathered from Proxmox VE cluster for use by the Prometheus monitoring system (2 days ago)
...
- [ellie/atuin](https://github.com/ellie/atuin) ([v0.10.0](https://github.com/ellie/atuin/releases/tag/v0.10.0), 1 week ago) - 🐢 Magical shell history
- [twpayne/chezmoi](https://github.com/twpayne/chezmoi) ([v2.17.1](https://github.com/twpayne/chezmoi/releases/tag/v2.17.1), 2 weeks ago) - Manage your dotfiles across multiple diverse machines, securely.
...
- [docs: metrics sample; token id](https://github.com/prometheus-pve/prometheus-pve-exporter/pull/114) on [prometheus-pve/prometheus-pve-exporter](https://github.com/prometheus-pve/prometheus-pve-exporter) (1 week ago)
- [docs: fix description for `-o`](https://github.com/nix-community/nixos-generators/pull/154) on [nix-community/nixos-generators](https://github.com/nix-community/nixos-generators) (4 weeks ago)
...
- [kizniche/ttn-tracker](https://github.com/kizniche/ttn-tracker) - Download GPS data transmitted to The Things Network for live display on a map (4 days ago)
