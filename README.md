...
- [coder/code-server](https://github.com/coder/code-server) ([v4.9.0-rc.2](https://github.com/coder/code-server/releases/tag/v4.9.0-rc.2), today) - VS Code in the browser
