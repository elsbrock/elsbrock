...
- [bitgapp/eqMac](https://github.com/bitgapp/eqMac) - macOS  System-wide Audio Equalizer &amp; Volume Mixer  🎧 (2 days ago)
- [octokit/graphql-action](https://github.com/octokit/graphql-action) - A GitHub Action to send queries to GitHub&#39;s GraphQL API (3 days ago)
- [fazalmajid/fts5index](https://github.com/fazalmajid/fts5index) - SQLite FTS5-based search engine for Hugo pages (3 days ago)
