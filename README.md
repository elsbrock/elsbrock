...
- [0xERR0R/blocky](https://github.com/0xERR0R/blocky) ([v0.33.0](https://github.com/0xERR0R/blocky/releases/tag/v0.33.0), 2 weeks ago) - Fast and lightweight DNS proxy as ad-blocker for local network with many features
...
- [SmtimesIWndr/gdid-reversal](https://github.com/SmtimesIWndr/gdid-reversal) -  (1 day ago)
- [wyattjoh/jmap-mcp](https://github.com/wyattjoh/jmap-mcp) - A Model Context Protocol (MCP) server that provides tools for interacting with JMAP (JSON Meta Application Protocol) email servers. Built with Deno and using the jmap-jam client library. (4 days ago)
- [devxplay/herdr.nvim](https://github.com/devxplay/herdr.nvim) - Neovim integration for Herdr pane navigation (6 days ago)
