...
- [hacs/default](https://github.com/hacs/default) - The home of the default HACS repositories. (5 days ago)
...
- [2Retr0/GodotOceanWaves](https://github.com/2Retr0/GodotOceanWaves) - FFT-based ocean-wave rendering, implemented in Godot (4 days ago)
- [paulrobello/parllama](https://github.com/paulrobello/parllama) - TUI for Ollama (6 days ago)
- [deggja/netfetch](https://github.com/deggja/netfetch) - Kubernetes tool for scanning clusters for network policies and identifying unprotected workloads. (6 days ago)
