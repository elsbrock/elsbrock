...
- [hacs/default](https://github.com/hacs/default) - The home of the default HACS repositories. (4 days ago)
...
- [2Retr0/GodotOceanWaves](https://github.com/2Retr0/GodotOceanWaves) - FFT-based ocean-wave rendering, implemented in Godot (3 days ago)
- [paulrobello/parllama](https://github.com/paulrobello/parllama) - TUI for Ollama (5 days ago)
- [deggja/netfetch](https://github.com/deggja/netfetch) - Kubernetes tool for scanning clusters for network policies and identifying unprotected workloads. (5 days ago)
- [pg-nano/pg-parser](https://github.com/pg-nano/pg-parser) - Parse your Postgres queries into a 100% type-safe AST (powered by libpg_query) (1 week ago)
- [jlandowner/helm-chartsnap](https://github.com/jlandowner/helm-chartsnap) - Snapshot testing tool for Helm charts (1 week ago)
