...
- [jetify-com/typeid](https://github.com/jetify-com/typeid) - Type-safe, K-sortable, globally unique identifier inspired by Stripe IDs (today)
- [signerlabs/klee-client](https://github.com/signerlabs/klee-client) -  (today)
- [mtth/avsc](https://github.com/mtth/avsc) - Avro for JavaScript :zap: (today)
