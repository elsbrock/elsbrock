...
- [ellie/atuin](https://github.com/ellie/atuin) ([v0.9.0](https://github.com/ellie/atuin/releases/tag/v0.9.0), today) - 🐢 Magical shell history
...
- [Add multi-arch Docker image build](https://github.com/cfunkhouser/tailscalesd/pull/8) on [cfunkhouser/tailscalesd](https://github.com/cfunkhouser/tailscalesd) (5 days ago)
...
- [janestreet/magic-trace](https://github.com/janestreet/magic-trace) - magic-trace collects and displays high-resolution traces of what a process is doing (today)
